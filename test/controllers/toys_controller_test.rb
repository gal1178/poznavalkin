...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { cost: @toy.cost, image: @toy.image, info: @toy.info, name: @toy.name } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { cost: @toy.cost, image: @toy.image, info: @toy.info, name: @toy.name } }
